...
BinarySearchTree.prototype.side = function(){
  return this.parent === null? null : (this.parent.left === this? 'left' : 'right');
};
...
BinarySearchTree.prototype.sibling = function(){
  return this.parent === null? null : this.parent[this.otherSide()];
};
...
BinarySearchTree.prototype.contains = function(value){
  return this.findNode(value).value === value;
};
